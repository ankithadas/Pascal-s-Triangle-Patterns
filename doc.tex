...
\begin{frame}
    \frametitle{Pascal's Triangle}
    \begin{itemize}
        %\item Understanding the divisibility of binomial coefficients by computing them is a bad idea
...
% \begin{frame}
%     Add a bigger picture of mod 2 pascal 
% \end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        % \begin{equation*}
        %     \binom{5+4}{4} = \binom{9}{4} = 2 \cdot 3 \cdot 11 \cdot 17 \cdot 19 \cdot 23
        % \end{equation*} 
...
%     % I want to make a good figure to show this 
% \end{frame}
